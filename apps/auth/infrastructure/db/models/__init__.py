...
from apps.auth.infrastructure.db.models.tenant_config_orm import TenantConfigORM
from apps.auth.infrastructure.db.models.tenant_domain_orm import TenantDomainORM
...
from apps.auth.infrastructure.db.models.two_factor_attempt_orm import TwoFactorAttemptORM

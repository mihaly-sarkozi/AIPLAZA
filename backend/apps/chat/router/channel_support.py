# backend/apps/chat/router/channel_support.py
# Feladat: Channel credential és channel chat session helper logikát tartalmaz. Credential secret kinyerést, tenant id ellenőrzést, expires_at parsingot, session cookie kezelést és session pacinget választ le a chat routerről. Program-specifikus channel API support réteg.

# backend/apps/chat/service/chat_http_use_cases.py
...
async def handle_channel_chat_request(
    *,
    ...
    if not chat_permission_service.can_use_channel_credential(principal, tenant_id=tenant_id):
        raise security_http_exception(status_code=401, code="UNAUTHORIZED", message="Authentication failed.")

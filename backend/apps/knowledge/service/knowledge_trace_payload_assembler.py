...
from apps.knowledge.service.knowledge_trace_quality_summary import KnowledgeTraceQualitySummary
...
class KnowledgeTracePayloadAssembler:
    def __init__(
        ...
        *,
        ...
        self._quality_summary = KnowledgeTraceQualitySummary()
    ...
    def build(self, *, query: Any, interpretation: Any | None) -> dict[str, Any]:
        ...
        quality_summary = self._quality_summary.build(run=run, subject_context_counters=subj_ctx_counters)

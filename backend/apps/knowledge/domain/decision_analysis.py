...
def decision_analysis_to_json_dict(analysis: DecisionAnalysis) -> dict[str, Any]:
    return {
        ...
        "decision_type": analysis.decision_type or analysis.decision,
        "selected_candidate_id": analysis.selected_candidate_id,
        "selected_candidate_score": analysis.selected_candidate_score,
        "attach_to": analysis.attach_to,
        "decision_confidence": analysis.decision_confidence,
        "selected_profile_id": analysis.selected_profile_id,
        "created_profile_id": analysis.created_profile_id,
        "decision_reason": analysis.decision_reason,
        "candidate_group_size": analysis.candidate_group_size,
        "competing_candidates_count": analysis.competing_candidates_count,
        "merge_candidate_group": dict(analysis.merge_candidate_group or {}),

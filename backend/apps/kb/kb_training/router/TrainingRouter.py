...
from apps.kb.kb_training.mapper.training_response_mapper import to_submit_response
...
@router.post("/{kb_id}/training/text", response_model=TrainingSubmitResponse)

...
# backend/apps/kb/kb_reading/security/FileSniffer.py
# Feladat: Fájl típus felismerés a fejléc bájtok alapján.
# Sárközi Mihály - 2026.06.07
from typing import BinaryIO
from core.kernel.config.config_loader import settings
from apps.kb.kb_reading.security.ArchiveGuard import ArchiveGuard, ReadingArchiveError
from apps.kb.kb_reading.support.ReadingConfig import DEFAULT_READING_CONFIG, ReadingConfig
from apps.kb.kb_reading.validation.ValidateFile import extension_from_filename

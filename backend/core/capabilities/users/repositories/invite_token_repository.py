# Meghívó tokenek kezelése regisztráció esetén.
...
from core.capabilities.users.dto import InviteToken
from core.capabilities.users.models.user_invite_token_orm import UserInviteTokenORM

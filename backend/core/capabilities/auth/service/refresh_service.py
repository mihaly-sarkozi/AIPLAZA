...
from core.capabilities.auth.dto import TenantAuthContext
...
from core.platform.auth.permissions_changed_store import get as permissions_changed_get
...
from core.capabilities.auth.service.refresh_result import RefreshFailed, RefreshFailReason, RefreshSuccess, RefreshResult

if TYPE_CHECKING:
    from core.capabilities.users.repositories import UserRepository

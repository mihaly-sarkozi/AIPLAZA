# core.capabilities.cache – cache kulcsok, helper-ek és backend factory
"""Cache package.
...
if TYPE_CHECKING:
    ...
    from core.capabilities.cache.memory_backend import MemoryCacheBackend
    from core.capabilities.cache.redis_backend import RedisCacheBackend
...
_LAZY_CLASSES = {
    "CacheBackend": ("core.capabilities.cache.ports", "CacheBackend"),
    "MemoryCacheBackend": ("core.capabilities.cache.memory_backend", "MemoryCacheBackend"),
    "RedisCacheBackend": ("core.capabilities.cache.redis_backend", "RedisCacheBackend"),
}

# Teljes audit log megvalósítása
# Belépés (siker/sikertelen), 2FA, kilépés, refresh, user CRUD.
...
# Tranzakciós use case-eknél ezt a service-t közvetlenül használjuk, így az audit
# ugyanabban a DB tranzakcióban kerül rögzítésre, mint az üzleti módosítás.

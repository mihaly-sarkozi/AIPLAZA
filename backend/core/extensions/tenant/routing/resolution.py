...
from core.extensions.tenant.routing.snapshot_codec import tenant_from_json, tenant_to_json
from core.extensions.tenant.ports import TenantReadRepositoryPort

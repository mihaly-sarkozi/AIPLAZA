# Ez a fájl a host alapú multitenancy middleware központi megvalósítását tartalmazza.
# A middleware feladata a tenant feloldása, a tenant cache használata, a request state feltöltése és a lifecycle szabályok érvényesítése.
# Itt találkozik a domain routing policy, a tenant snapshot modell és a HTTP kérésfeldolgozás hot pathja.
# Bármilyen tenant routing, cache invalidáció vagy request-szintű tenant kontextus változás ennél a fájlnál fut össze.
...
from core.extensions.tenant.dto import TenantDomainInfo
...
from core.extensions.tenant.routing.request_state import apply_tenant_snapshot, initialize_tenant_state
from core.extensions.tenant.routing.resolution import TenantResolutionService

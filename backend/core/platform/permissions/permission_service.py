...
# Ez a függvény felépíti a(z) alapértelmezett szerepkör permissions logikáját.
...
class PermissionService:
    ...
    # Ez a metódus regisztrálja a(z) permissions logikáját.
    ...
    # Ez a metódus listázza a(z) permissions for szerepkör logikáját.
    ...
    # Ez a metódus a(z) has_role_permission logikáját valósítja meg.
    ...
    # Ez a metódus a(z) has_permission logikáját valósítja meg.
    ...
    # Ez a metódus a(z) has_any_permission logikáját valósítja meg.

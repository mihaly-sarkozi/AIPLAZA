...
__all__ = ["get_limiter", "get_rate_limit_redis", "limiter", "refresh_token_key", "user_or_ip_key"]

_LAZY: dict[str, tuple[str, str]] = {
    "get_limiter": ("core.kernel.security.rate_limit.rate_limit_middleware", "get_limiter"),
    "get_rate_limit_redis": ("core.kernel.security.rate_limit.rate_limit_middleware", "get_rate_limit_redis"),

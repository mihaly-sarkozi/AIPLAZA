...
#
# Felelősség: ASGI middleware – Bearer token ellenőrzés, allowlist, user
# feloldása (cache → DB → minimál payload), version check.
# Szerializáció és cache segédek → user_cache.py.
...
from core.kernel.middleware.security.user_cache import (
    get_cached_user,

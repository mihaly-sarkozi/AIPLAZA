...
from core.capabilities.audit.tenant_hooks import register_audit_tenant_hooks
from core.capabilities.users.container.users_container import build_users_feature
from core.capabilities.users.tenant_hooks import register_users_tenant_hooks
from core.platform.composition import AppModule, ModuleContext
from core.platform.contract.state_keys import CTX_STATE_USERS_FEATURE
...
class UsersPlatformModule(AppModule):
    key = "platform.users"

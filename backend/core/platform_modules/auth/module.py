...
from core.capabilities.auth.container.auth_container import build_auth_feature
from core.capabilities.auth.service import LoginService, LogoutService, RefreshService, TwoFactorService
from core.capabilities.auth.tenant_hooks import register_auth_tenant_hooks
from core.platform.composition import AppModule, ModuleContext
from core.platform.contract.state_keys import CTX_STATE_AUTH_FEATURE
...
from core.platform.auth.two_factor_policy import (
...
class AuthPlatformModule(AppModule):
    key = "platform.auth"

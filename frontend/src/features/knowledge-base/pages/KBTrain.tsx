    ...
    <div className="p-6 min-h-full bg-[var(--color-background)]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-[var(--color-card)] border border-[var(--color-border)] p-6 rounded-lg">
          ...
          <button
            type="button"
            className="bg-[var(--color-card)] border border-[var(--color-border)] text-[var(--color-foreground)] px-4 py-2 rounded mt-5 hover:bg-[var(--color-button-hover)] disabled:opacity-50 disabled:cursor-not-allowed"
            onClick={trainFile}

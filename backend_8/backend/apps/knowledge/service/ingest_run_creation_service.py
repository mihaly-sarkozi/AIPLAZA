...
class IngestRunCreationDependencies:
    knowledge_audit_service: Any
    ingest_item_store: Any
    ingest_input_store: Any
    source_storage_service: Any
    url_fetch_service: Any
    require_corpus: Callable[[str], Any]
    ingest_runs: Callable[[], Any]
    ensure_title: Callable[..., str]
    refresh_ingest_run: Callable[[str], IngestRun]
    log_step: Callable[..., None]


class IngestRunCreationService:
    def __init__(self, dependencies: IngestRunCreationDependencies, *, progress_service: IngestProgressService) -> None:
        self._knowledge_audit_service = dependencies.knowledge_audit_service
        self._ingest_item_store = dependencies.ingest_item_store
        self._ingest_input_store = dependencies.ingest_input_store
        self._source_storage_service = dependencies.source_storage_service
        self._url_fetch_service = dependencies.url_fetch_service
        self._require_corpus = dependencies.require_corpus
        self._ingest_runs = dependencies.ingest_runs
        self._ensure_title = dependencies.ensure_title
...
__all__ = ["IngestRunCreationDependencies", "IngestRunCreationService"]

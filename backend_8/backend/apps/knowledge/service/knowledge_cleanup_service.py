...
class KnowledgeCleanupDependencies:
    corpus_store: Any
    ingest_input_store: Any
    index_build_store: Any
    object_storage: Any
    vector_index_factory: Any
    ingest_event_store: Any
...
class KnowledgeCleanupService:
    def __init__(self, dependencies: KnowledgeCleanupDependencies) -> None:
...
__all__ = ["KnowledgeCleanupDependencies", "KnowledgeCleanupService"]

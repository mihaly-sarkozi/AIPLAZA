...
from apps.knowledge.errors import KnowledgeSourceNotFound, KnowledgeSourceUnavailable
    ...
    def parse_source(
        ...
        *,
        ...
        try:
            ...
            if not raw_text:
                raise KnowledgeSourceUnavailable(self._describe_empty_extraction(extracted_document.metadata))

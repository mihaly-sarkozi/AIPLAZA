# Ez a fájl a(z) vehicle_detector modul backend logikáját tartalmazza.
"""
...
class VehicleDetector(BaseDetector):
    ...
    # Ez a metódus a(z) context_boost logikáját valósítja meg.
    ...
    # Ez a metódus a(z) context_penalty logikáját valósítja meg.

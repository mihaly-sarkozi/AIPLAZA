# Ez a fájl az adott területhez tartozó szabályokat és döntési logikát tartalmazza.
"""
...
_DEFAULT_ENTITY_RISK: dict[EntityType, RiskClass] = {
    ...
    EntityType.USER_ID: RiskClass.INDIRECT_IDENTIFIER,
    EntityType.COOKIE_ID: RiskClass.INDIRECT_IDENTIFIER,
...
class PolicyEngine:
    ...
    # Ez a metódus a(z) entity_to_risk logikáját valósítja meg.
    ...
    # Ez a metódus a(z) risk_to_action logikáját valósítja meg.
    ...
    # Ez a metódus a(z) decide_all logikáját valósítja meg.

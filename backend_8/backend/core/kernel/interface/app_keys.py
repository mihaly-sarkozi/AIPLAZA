...
# Feladat: App modulokhoz tartozó module.* service kulcsok kanonikus helye. A module_service_key helperrel egységes névteret ad, hogy routerek, dependency-k és modul regisztrációk ne raw stringeket használjanak. Public app integration interface, amelyet app modulok importálnak.
